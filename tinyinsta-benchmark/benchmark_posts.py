...
class PostsBenchmark:
    ...
    def run_posts_benchmark(self):
        print("=== BENCHMARK NOMBRE DE POSTS ===")
        
        configs = [
            ("bench10", 10, "10 posts par user"),
            ("bench100", 100, "100 posts par user"), 
            ("bench1000", 1000, "1000 posts par user")
        ]
        
        with open('out/post.csv', 'w', newline='') as csvfile:
...
if __name__ == "__main__":
    ...
    benchmark = PostsBenchmark(BASE_URL)
